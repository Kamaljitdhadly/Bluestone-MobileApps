using Bluestone.Domain.Entities.Users.RequestModels;
using FluentValidation;

namespace Bluestone.Application.Users.Validators
{
    public class UpsertUserRequestValidator : AbstractValidator<UpsertUserRequestModel>
    {
