...
namespace Bluestone.Mobile.Presentation.ViewModels.Account
{
    public class SettingsViewModel : ViewModelBase
    {
        ...
        public ICommand SystemThemeCommand => new Command<CheckedChangedEventArgs>((item) => RequestedThemeChangedAsync(item, (int)AppThemeEnum.System));
        public ICommand LightThemeCommand => new Command<CheckedChangedEventArgs>((item) => RequestedThemeChangedAsync(item, (int)AppThemeEnum.Light));
        public ICommand DarkThemeCommand => new Command<CheckedChangedEventArgs>((item) => RequestedThemeChangedAsync(item, (int)AppThemeEnum.Dark));
