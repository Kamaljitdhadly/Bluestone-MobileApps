using Bluestone.Mobile.Presentation.Views.Identity;
using Bluestone.Mobile.Presentation.Views.Message;
using Bluestone.Mobile.Presentation.Views.Patient;
using Bluestone.Mobile.Presentation.Views.Account;
using Xamarin.Forms;
...
namespace Bluestone.Mobile.Presentation.GlobalSettings
{
    internal static class AppRoutingConstants
    {
        ...
        public const string CreateMessagePageRoute =  nameof(CreateGeneralMesage);
    ...
    internal static class AppRouting
    {
        internal static void RegisterRoute()
        {
            ...
            Routing.RegisterRoute(route: AppRoutingConstants.CreateMessagePageRoute, typeof(CreateGeneralMesage));
