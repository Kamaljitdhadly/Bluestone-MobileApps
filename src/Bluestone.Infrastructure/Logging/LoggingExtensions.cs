...
namespace Bluestone.Infrastructure.Logging
{
    public static class LoggingExtensions
    {
        private static void UseBluestoneLogger(this IWebHostEnvironment env, LoggingOptions options)
        {
        ...
        public static IWebHostBuilder UseBluestoneLogger(this IWebHostBuilder builder, Func<IConfiguration, LoggingOptions> logOptions)
        {
            builder.ConfigureLogging((context, logging) =>
            {
                ...
                context.HostingEnvironment.UseBluestoneLogger(options);
            });

            return builder;
        }

        public static IHostBuilder UseBluestoneLogger(this IHostBuilder builder, Func<IConfiguration, LoggingOptions> logOptions)
        {
            builder.ConfigureLogging((context, logging) =>
            {
                logging.Configure(options =>
        ...
        private static void UseBluestoneLogger(this IHostEnvironment env, LoggingOptions options)
        {
            var assemblyName = Assembly.GetEntryAssembly()?.GetName().Name;
